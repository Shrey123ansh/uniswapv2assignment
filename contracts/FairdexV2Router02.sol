...
contract FairdexV2Router02 is IFairdexV2Router02 {
        ...
        returns (uint amountToken, uint amountETH, uint liquidity)
    {
        ...
        address pair = FairdexV2Library.pairFor(factory, token, WETH);
    ...
    function swapExactETHForTokens(
        ...
        returns (uint[] memory amounts)
    {
        require(path[0] == WETH, "FairdexV2Router: INVALID_PATH");
    ...
    function swapTokensForExactETH(
        ...
        returns (uint[] memory amounts)
    {
        require(path[path.length - 1] == WETH, "FairdexV2Router: INVALID_PATH");
        amounts = FairdexV2Library.getAmountsIn(factory, amountOut, path);
        require(
            amounts[0] <= amountInMax,
            "FairdexV2Router: EXCESSIVE_INPUT_AMOUNT"
